...
//            startValidation(user, password);
     ...
     * @return 是否正确
     */
    private Boolean startValidation(String user, String password) {
        if (DUMMY_CREDENTIALS[0].equals(user)) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            return startValidation(mUser, mPassword);
        }
